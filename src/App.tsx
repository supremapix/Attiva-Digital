...
const resultsData = [
  {
    ...
    metric: "+450%",
    description: "Aumento médio de tráfego orgânico para nossos clientes em 2025.",
    chartData: [10, 25, 45, 60, 85, 120, 150, 180, 220, 280, 350, 450]
  },
  {
    title: "Redução de CAC",
    metric: "-35%",
    description: "Otimização de campanhas resultando em menor custo de aquisição.",
    chartData: [100, 95, 90, 85, 80, 75, 70, 68, 67, 66, 65, 65]
  },
  {
    title: "Taxa de Conversão",
    metric: "8.5%",
    description: "Média de conversão em landing pages de alta performance.",
    chartData: [2.1, 2.5, 3.2, 3.8, 4.5, 5.2, 5.8, 6.5, 7.2, 7.8, 8.2, 8.5]
  }
];
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center overflow-hidden z-10">
                    ...
                    {p.svg ? (
                      ...
                      <Layers size={64} className="opacity-50 text-gold-primary group-hover:scale-125 group-hover:opacity-100 transition-all duration-700 drop-shadow-[0_0_35px_rgba(201,168,76,0.8)]" />
                    )}
                  </div>
